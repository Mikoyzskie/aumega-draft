...
export default function HeroBanner() {
    return (
        <>
            <div className="relative container px-4 mx-auto z-20 min-h-[calc(100vh-85.6px)] flex flex-col justify-center pt-[118px]">
                        ...
                        <div className="w-full lg:w-2/5 px-4 mb-16 lg:mb-0">
                            <div className="relative max-w-lg lg:max-w-md mx-auto lg:mx-0">
                                <img
                                    ...
                                    src="https://shuffle.dev/saturn-assets/images/headers/image-header-2.png"
                                    alt=""
                                />
                        ...
                        <div className="w-full lg:w-3/5 px-4">
                            <div className="max-w-lg lg:max-w-2xl mx-auto lg:mr-0">
                                <div className="max-w-2xl">
                                    <h1 className="font-heading text-xl xs:text-xl md:text-7xl font-bold text-gray-900 mb-8 sm:mb-14">
                                        <span>Elevate Your Space</span>
                                        <span className="font-serif italic"> With Timeless Beauty</span>
                                    </h1>
                                </div>
